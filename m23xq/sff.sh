...
# SEC Floating Feature configuration file for Galaxy M23 5G (m23xq)
...
SEC_FLOATING_FEATURE_CAMERA_CONFIG_VENDOR_LIB_INFO=beauty.samsung.v4,face_landmark.arcsoft.v2_1,facial_attribute.samsung.v1,swuwdc.arcsoft.v1,event_detection.samsung.v2,food.samsung.v1,selfie_correction.samsung.v1,dual_bokeh.samsung.v1,single_bokeh.samsung.v2,image_enhance.arcsoft.v1,scene_detection.samsung.v1,smart_scan.samsung.v2,mfhdr.arcsoft.v1,llhdr.arcsoft.v1,human_tracking_face.arcsoft.v2_1,localtm.samsung.v1_1
...
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_m23xq_sm7225
...
# Device specific
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy M23 5G
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMM236B
